    ...
    internal class DeaCustDAL
    {
        ...
        public bool Update(DeaCustBLL dc)
        {
            ...
            try
            {
                ...
                string sql = "UPDATE tbl_deal_cust SET type=@type, name=@name, email=@email, contact=@contact, address=@address, added_date=@added_date, added_by=@added_by WHERE deal_cust_id=@deal_cust_id";
                ...
                cmd.Parameters.AddWithValue("@added_date", dc.added_date);
                cmd.Parameters.AddWithValue("@added_by", dc.added_by);
                cmd.Parameters.AddWithValue("@deal_cust_id", dc.deal_cust_id);
        ...
        public bool Delete(DeaCustBLL dc)
        {
            ...
            try
            {
                ...
                string sql = "DELETE FROM tbl_deal_cust WHERE deal_cust_id=@deal_cust_id";
        ...
        public DataTable Search(string keyword)
        {
            ...
            try
            {
                ...
                string sql = "SELECT * FROM tbl_deal_cust WHERE deal_cust_id LIKE '%" + keyword + "%' OR type LIKE '%" + keyword + "%' OR name LIKE N'%" + keyword + "%'";
        ...
        public DeaCustBLL SearchDealerCustomerForTransaction(string keyword)
        {
            ...
            try
            {
                ...
                string sql = "SELECT name, email, contact, address from tbl_deal_cust WHERE deal_cust_id LIKE '%" + keyword + "%' OR name LIKE '%" + keyword + "%'";
        ...
        public DeaCustBLL GetDeaCustIDFromName(string Name)
        {
            ...
            try
            {
                ...
                string sql = "SELECT deal_cust_id FROM tbl_deal_cust WHERE name= N'" + Name + "'";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    dc.deal_cust_id = int.Parse(dt.Rows[0]["deal_cust_id"].ToString());
                }
            }
            catch (Exception ex)
            {

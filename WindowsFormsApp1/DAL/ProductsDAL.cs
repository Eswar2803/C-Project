    ...
    internal class ProductsDAL
    {
        ...
        public DataTable Search(string keywords)
        {
            ...
            try
            {
                ...
                string sql = "SELECT * FROM tbl_products WHERE id LIKE '%" + keywords + "%' OR name LIKE N'%" + keywords + "%' OR category LIKE '%" + keywords + "%'";
        ...
        public ProductsBLL GetProductsForTransaction(string keyword)
        {
            ...
            try
            {
                ...
                string sql = "SELECT name, rate, qty FROM tbl_products WHERE id LIKE '%" + keyword + "%' OR name LIKE N'%" + keyword + "%'";
        ...
        public ProductsBLL GetProductIDFromName(string ProductName)
        {
            ...
            try
            {
                ...
                string sql = "SELECT id FROM tbl_products WHERE name=N'" + ProductName + "'";
